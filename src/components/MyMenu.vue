    ...
    <a-row :wrap="false">
      ...
      <a-col flex="200px">
        <div class="user_login">
          <a-button class="login" type="text">Log in</a-button>
          <a-button class="start" type="primary">Start free trial</a-button>
        </div>
      </a-col>
    </a-row>
